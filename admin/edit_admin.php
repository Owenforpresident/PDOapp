...
if($run){
    ...
    redirect('my_admin.php'); //if it runs direct them back to main admin page, with the message success    
    keepmsg('<div class="alert alert-success text-center">
          ...
          <strong>Success!</strong> Update successfully
            ...
            redirect('my_admin.php');    //or rediret them back to main admin page with a it didnt work message       
